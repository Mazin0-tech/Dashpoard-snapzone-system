                ...
                <div class="card-body" style="background-color: #f7f7f7;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn animate__delay-1s">
                            <label for="name" class="form-label" style="font-weight: bold; color: #333;">{{ __('Name') }}</label>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn animate__delay-4s">
                            <label for="password-confirm" class="form-label" style="font-weight: bold; color: #333;">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="d-flex justify-content-between animate__animated animate__fadeIn animate__delay-5s">
                            ...
                            <a class="btn btn-link" href="{{ route('login') }}" style="font-size: 14px; text-decoration: none; color: #007bff;">
