                        ...
                        @foreach($team as $teams) 
                            <tr>
                                ...
                                <td>
                                        ...
                                        <img src="{{ asset($teams->image) }}" alt="{{ $teams->name }}" style="width: 50px; border-radius: 10px; margin: auto;">
                                  
                                </td>
                                <td>{{ $teams->name }}</td>
                                <td>{{ $teams->linkedin }}</td>
                                <td>{{ $teams->jobtitle }}</td>
                                <td>
                                    <a href="{{ route('team.edit' , $teams->id) }}" class="btn btn-primary">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <form class="m-auto d-inline" method="post" action="{{ route('team.destroy',$teams->id) }}" onsubmit="return confirm('Are you sure you want to delete this Team post?');">
                                        @csrf
                                        @method('delete')
