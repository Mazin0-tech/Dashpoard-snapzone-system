            ...
            <div class="col-md-12">
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <div class="card-title">Edit Partner - {{ $partner->title }}</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('partners.update', $partner->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="logo-comparison mb-4">
                                        @if($partner->logo)
                                        <div class="logo-section">
                                            <label class="form-label">Current Logo:</label>
                                            <div class="logo-preview-item current-logo">
                                                <img src="{{ $partner->logo }}" alt="Current Logo">
                                            </div>
                                        ...
                                        <div class="logo-section">
                                            ...
                                            <div class="logo-preview mb-3" id="logoPreview" style="display: none;">
                                                <div class="logo-preview-item">
                                                    <img id="previewImage" src="" alt="New Logo Preview">
                                                </div>
                                            </div>
                                            <small class="text-muted" id="previewText">No new logo selected</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#logo').on('change', function(e) {
                ...
                if (files.length > 0) {
                    ...
                    reader.onload = function(e) {
                        ...
                        preview.show();
                        previewText.text('New logo preview');
                    };
                    
                    reader.readAsDataURL(file);
                } else {
                    preview.hide();
                    previewText.text('No new logo selected');
                }
            });
