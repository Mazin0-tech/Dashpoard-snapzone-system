                        ...
                        @foreach($services as $service) 
                            <tr>
                                ...
                                <td>
                                        ...
                                        <img src="{{  asset($service->image) }}" alt="{{ $service->title }}" style="width: 50px; border-radius: 10px; margin: auto;">
                                ...
                                <td>
                                    ...
                                    <form class="m-auto d-inline" method="post" action="{{ route('service.destroy', $service->id) }}">
                                        @csrf
                                        @method('delete')
